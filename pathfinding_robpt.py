...
class Pathfinder:
	def __init__(self,matrix):
		...
		# robot
		self.robot = pygame.sprite.GroupSingle(robot(self.empty_path))
	...
	def create_path(self):
		...
		# start
		start_x, start_y = self.robot.sprite.get_coord()
		...
		self.grid.cleanup()
		self.robot.sprite.set_path(self.path)
...
# game setup
mapfile = 'map.png'
bg_surf = pygame.image.load(mapfile).convert()
